...
(function () {
    ...
    function triggerGoldenHook(offer, reason) {
        ...
        const hookHTML = `
            <div id="santis-golden-hook" style="pointer-events: auto; z-index: 9999;" class="fixed bottom-8 right-8 opacity-0 translate-y-4 transition-all duration-700 ease-out flex items-center gap-4 p-5 rounded-xl bg-black/85 backdrop-blur-md border border-lux-gold/40 shadow-[0_0_40px_rgba(212,175,55,0.15)] max-w-sm">
                <div class="flex-shrink-0 w-12 h-12 rounded-full bg-lux-gold/10 flex items-center justify-center border border-lux-gold/30 text-lux-gold shadow-[inset_0_0_10px_rgba(212,175,55,0.2)]">
                ...
                <div class="flex-1">
                    <p class="text-lux-gold text-[10px] font-bold tracking-widest uppercase mb-1 drop-shadow-[0_0_2px_rgba(212,175,55,0.8)]">Sovereign Concierge</p>
                    ...
                    <div class="mt-4 flex items-center justify-between">
                        ...
                        <button class="text-[10px] bg-lux-gold/10 text-lux-gold border border-lux-gold/50 hover:bg-lux-gold hover:text-black font-bold py-1.5 px-4 rounded transition-all tracking-widest uppercase shadow-[0_0_10px_rgba(212,175,55,0.2)]">Ayrıcalığı Al</button>
                    </div>
                </div>
            </div>
        `;
