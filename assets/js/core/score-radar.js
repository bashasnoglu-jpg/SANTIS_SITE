...
window.ScoreRadar = {
    ...
    _renderTimeline() {
        ...
        el.innerHTML = this._rescueLog.map(r => `
            <div class="flex" style="justify-content:space-between; align-items:center; padding:4px 8px; margin-bottom:3px; background:rgba(212,175,55,0.06); border-left:2px solid #c6a96b; border-radius:0 4px 4px 0; font-size:9px;">
                ...
                <span class="text-lux-gold" style="font-family:monospace;">${r.score}</span>
