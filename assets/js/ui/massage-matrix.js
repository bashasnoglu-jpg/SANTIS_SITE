        ...
        if (type === 'MATRIX_READY') {
                    ...
                    if (layout === 'coverflow') {
                            ...
                            <div class="santis-reveal-data">
                                ...
                                <div class="flex" style="gap: 20px; justify-content: center; margin-bottom: 50px;">
                                    <div style="background: rgba(0,0,0,0.4); padding: 15px 30px; border-radius: 12px; border: 1px solid rgba(212,175,55,0.3); backdrop-filter: blur(10px);">
                                        <span class="text-lux-gold" style="display: block; font-size: 0.8rem; letter-spacing: 2px;">SÜRE</span>
                                        <strong style="font-size: 1.3rem;">60 Dk</strong>
                                    </div>
                                    <div style="background: rgba(0,0,0,0.4); padding: 15px 30px; border-radius: 12px; border: 1px solid rgba(212,175,55,0.3); backdrop-filter: blur(10px);">
                                        <span class="text-lux-gold" style="display: block; font-size: 0.8rem; letter-spacing: 2px;">BÖLGE</span>
                        ...
                        card.innerHTML = `
                            ...
                            <div class="relative flex" style="z-index:1; padding: 2rem; flex-direction:column; justify-content:flex-end; height: 100%; background: linear-gradient(to top, rgba(0,0,0,0.9), transparent);">
                                <h3 class="text-lux-gold" style="font-family:;'Playfair Display', serif; font-size:2rem; margin:0;">${title}</h3>
                        ...
                        card.innerHTML = `
                            ...
                            <div class="w-full" style="position: absolute; bottom: 0; left: 0; padding: 24px; z-index: 2;">
                                ...
                                <div class="flex" style="justify-content: space-between; align-items: center; border-top: 1px solid rgba(255,255,255,0.1); padding-top: 12px;">
                                    ...
                                    <span class="text-lux-gold" style="font-family:;'Inter', sans-serif; font-size: 0.8rem; letter-spacing: 1px;">KEŞFET &rarr;</span>
                                </div>
                            </div>
                        `;
                    }
            ...
            if (oracleGrid && window.Santis.State.page === 'hamam') {
                ...
                for (let idx = 0; idx < quickAccessList.length; idx++) {
                    ...
                    oracleHtml += `
                    <a href="${detailUrl}" class="matrix-service-card" style="flex-shrink: 0; scroll-snap-align: start; width: 480px; height: 600px; border-radius: 20px; overflow: hidden; border: ${isPriority ? '2px solid #c6a96b' : '2px solid transparent'}; position: relative; background: #080808; text-decoration: none; display: flex; flex-direction: column; justify-content: flex-end; opacity: 0; transform: translateY(20px); transition: transform 0.6s cubic-bezier(0.16, 1, 0.3, 1), opacity 0.6s ease; animation: fadeIn 0.5s ease forwards ${idx * 0.05}s;">
                        ...
                        <div class="relative flex w-full" style="z-index: 2; padding: 40px 32px; flex-direction: column; gap: 12px;">
                            <span style="font-family: 'Inter', sans-serif; font-size: 0.75rem; color: #c6a96b; font-weight: 600; letter-spacing: 1.5px; text-transform: uppercase;">${dur} DK. RİTÜELİ</span>
                            ...
                            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-top: 32px; padding-top: 24px; border-top: 1px solid rgba(255,255,255,0.1);">
                                ...
                                <div class="flex" style="background: rgba(255,255,255,0.03); padding: 16px; border-radius: 12px; flex-direction: column; gap: 6px;">
                                    ...
                                    <span class="text-lux-gold" style="font-size: 1.1rem; font-family:;'Inter', sans-serif; font-weight: 500;">${price}</span>
                                </div>
                            </div>
                        </div>
                    </a>`;
