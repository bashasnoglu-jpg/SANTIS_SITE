    ...
    renderSkeleton() {
        this.innerHTML = `
            <div class="rounded-2xl border border-white/10 bg-black/20 p-4 backdrop-blur font-mono flex justify-between items-center shadow-xl">
                <div>
                    <h3 class="text-xs uppercase tracking-widest text-white/50 mb-1">Live Revenue Pulse</h3>
                    <div class="flex items-baseline">
                        <span id="revenue-pulse-amount" class="text-2xl text-nv-gold font-bold transition-colors duration-300">
                            €0
                        </span>
