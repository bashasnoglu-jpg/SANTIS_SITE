...
const SantisFibonacciSwarm = (() => {
    ...
    const init = () => {
        ...
        canvas.style.cssText = 'position:fixed;top:0;left:0;width:100vw;height:100vh;z-index:-1;pointer-events:none;mix-blend-mode:screen;opacity:0;transition:opacity 2s ease;';
