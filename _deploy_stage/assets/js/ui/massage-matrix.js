...
export function init(kernelWorker) {
    ...
    const failsafeTimer = setTimeout(() => {
        ...
        console.warn('⏰ [Massage UI] Worker 5sn timeout — arena opacity açıldı (failsafe).');
    }, 5000);
            ...
            for (const arena of arenas) {
                ...
                for (let index = 0; index < filteredData.length; index++) {
                    ...
                    if (layout === 'giant-rail') {
                        ...
                        card.style.height = '50vh'; // Ekranın yarısına kadar aç
                        ...
                        card.style.minHeight = '50vh'; // Görseller ekranın yarısına kadar
