    ...
    <div className="min-h-screen bg-[#0A0908] text-[#E5E0D8] font-sans flex selection:bg-[#C2A878]/30 selection:text-[#E5E0D8]">
        ...
        <div className="p-6">
          ...
          <nav className="space-y-2">
            <button 
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-sm text-sm transition-colors ${activeTab === 'telemetry' ? 'bg-[#1A1817] border border-[#C2A878]/30 text-[#C2A878]' : 'bg-transparent border border-transparent hover:bg-[#1A1817] hover:border-[#2A2624] text-[#B7ADA1] hover:text-[#E5E0D8]'}`}
            >
              <LayoutDashboard className="w-4 h-4" /> Telemetri Özeti
            </button>
            <button 
              onClick={() => setActiveTab('psychology')}
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-sm text-sm transition-colors ${activeTab === 'psychology' ? 'bg-[#1A1817] border border-[#C2A878]/30 text-[#C2A878]' : 'bg-transparent border border-transparent hover:bg-[#1A1817] hover:border-[#2A2624] text-[#B7ADA1] hover:text-[#E5E0D8]'}`}
            >
              <Brain className="w-4 h-4" /> Psikolojik Katman
            </button>
            <button 
              onClick={() => setActiveTab('journey')}
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-sm text-sm transition-colors ${activeTab === 'journey' ? 'bg-[#1A1817] border border-[#C2A878]/30 text-[#C2A878]' : 'bg-transparent border border-transparent hover:bg-[#1A1817] hover:border-[#2A2624] text-[#B7ADA1] hover:text-[#E5E0D8]'}`}
            >
      ...
      <main className="flex-1 flex flex-col min-h-screen overflow-hidden relative">
        ...
        <header className="h-24 px-8 border-b border-[#2A2624] flex items-center justify-between bg-[#141211]/80 backdrop-blur-md z-10 sticky top-0">
          <div>
            <h2 className="font-serif text-2xl text-[#E5E0D8]">
