          ...
          [...decisions].reverse().map((decision, index) => (
            ...
            >
              <div className="flex items-center justify-between">
                <span className="font-bold tracking-wider text-[10px] uppercase text-sky-300">{decision.decision}</span>
                <span className="text-[10px] text-neutral-400">{decision.operatorId}</span>
              </div>
