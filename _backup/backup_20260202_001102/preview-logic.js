...
function openPreviewModal(mediaUrl, type) {
    ...
    modal.innerHTML = `
        <div style="position:relative;">
            ${contentHtml}
            <button onclick="closePreviewModal()" style="position:absolute; top:-40px; right:0; background:none; border:none; color:white; font-size:30px; cursor:pointer;">&times;</button>
        </div>
    `;
