...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (!window.GALLERY_DATA) {
        console.warn("window.GALLERY_DATA bulunamadı. Lütfen gallery-data.js dosyasını kontrol edin.");
        return;
    }
    ...
    window.GALLERY_DATA.forEach((item, index) => {
        // Kategori Güvenliği
        ...
        // Path düzeltme (Base href="/" olduğu için relative ../.. çalışmaz)
