...
(function () {
    ...
    if (window.__eventBindingsLoaded) {
        console.warn("⚠️ [Event Bindings] Already loaded. Skipping duplicate execution.");
        return;
    }
    window.__eventBindingsLoaded = true;
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // =====================================================================
        document.addEventListener('click', function (e) {
            // DEBUG: Trace all clicks
            console.log("🖱️ Click detected:", e.target);

            var el = e.target.closest('[data-action]');
            if (!el) return;
            console.log("⚡ Action Triggered:", el.getAttribute('data-action'));
