...
const MediaLibrary = {
    ...
    async scanProductUsage() {
        ...
        this.knownImages.add('/assets/img/placeholder.webp');
        this.knownImages.add('/assets/img/luxury-placeholder.webp');
    },
    ...
    render() {
        ...
        list.forEach(img => {
            ...
            card.innerHTML = `
                <div class="flex" style="height:120px; background:#000; align-items:center; justify-content:center; overflow:hidden;">
                    <img class="w-full" src="${img.startsWith('/') ? img : '/' + img}" style="height:100%; object-fit:cover; opacity:0.8; transition:opacity 0.3s;" data-fallback-src="/assets/img/placeholder.webp">
                </div>
                <div style="padding:10px;">
                    ...
                    <button class="w-full btn-os sm" data-action="media-select" data-path="${escapeAttr(img)}" style="margin-top:8px; border-color:#444;">Kopyala / Seç</button>
                </div>
            `;
