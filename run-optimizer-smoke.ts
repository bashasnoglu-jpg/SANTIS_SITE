import { derivePolicyOptimizerOutput } from './server/core/concierge/optimizer/optimizer.adapter.ts';
import { optimizerReasonCodes } from './server/core/concierge/optimizer/optimizer.rules.ts';
...
const cases = [
  ...
  },
  {
    ...
    expected: {
      direction: 'decrease', // Since candidate < current, direction is mechanically 'decrease', but reason should be NO_CLEAR_WINNER
      reasons: [
