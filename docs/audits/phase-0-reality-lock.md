...
[ ] branch prefix standardı yazıldı
[ ] eski branch’ler sınıflandırıldı
[ ] teknik borç raporu oluşturuldu
[ ] dead code adayları karantinaya alındı
[ ] package manager canonical hale getirildi
[ ] duplicate UI kaynakları listelendi
[ ] build en az bir kere temiz çalıştı
[ ] GitHub branch protection açıldı
