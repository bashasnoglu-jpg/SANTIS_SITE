...
def create_access_token(
    ...
    to_encode = {
        ...
        "tenant": str(tenant_id) if tenant_id else None, # SaaS Isolation
        "tv": token_version,             
        "type": "access"
    }
...
def decode_token(token: str) -> dict:
    try:
        ...
        required_custom_claims = ["jti", "role", "region", "tenant"]
        ...
        allowed_roles = ["admin", "super_admin", "editor", "OWNER", "MANAGER", "STAFF", "USER"]
