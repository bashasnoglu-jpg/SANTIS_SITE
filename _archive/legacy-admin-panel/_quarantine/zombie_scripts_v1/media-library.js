        ...
        list.forEach(img => {
            ...
            card.innerHTML = `
                <div style="height:120px; background:#000; display:flex; align-items:center; justify-content:center; overflow:hidden;">
                    <img src="${img.startsWith('/') ? img : '/' + img}" style="width:100%; height:100%; object-fit:cover; opacity:0.8; transition:opacity 0.3s;" data-fallback-src="/assets/img/placeholder.webp">
                </div>
