...
async function loadIntelligenceReport() {
    try {
        ...
        if (report.semantic.tone_violations.length === 0) {
            semList.innerHTML = "<div class="text-center" style='color:#00ff88; padding:20px;'>✨ Great! No tone violations found.</div>";
        } else {
        ...
        if (report.crawler.broken_links.length === 0) {
            crawlList.innerHTML = "<div class="text-center" style='color:#00ff88; padding:20px;'>✨ Clean! No broken links found.</div>";
        } else {
