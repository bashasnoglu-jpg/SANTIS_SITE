...
// [Sovereign Purge]     setInterval(updateAIBrain, 30000);
// [Sovereign Purge]     setInterval(updateShadowLog, 3000);
// [Sovereign Purge]     setInterval(updateSovereignTelemetry, 3000); // Telemetry Live Sync (Pulse) every 3s
// [Sovereign Purge]     setInterval(updateSovereignPulse, 4000);   // Sovereign Pulse tracking
...
// [Sovereign Purge]             _godModeInterval = setInterval(() => window.initGodMode(false), 30000);
        }
    }, 2500);
});
