...
(function () {
    ...
    function createOverlay() {
        ...
        _overlayEl.innerHTML =
            ...
            '<span class="hidden" id="sa-health-error-count" style="background:rgba(255,68,68,0.2); color:#ff4444; padding:1px 6px; border-radius:8px; font-size:10px; font-weight:600;">0</span>' +
    ...
    function renderDetailPanel() {
        ...
        panel.innerHTML =
            ...
            '<span class="text-[#d4af37]" style="font-weight:600;">SantisOS Health</span>' +
            '<span class="cursor-pointer" style="color:#444;" id="sa-health-close">✕</span></div>' +

            '<div style="display:grid; grid-template-columns:1fr 1fr; gap:8px; margin-bottom:12px;">' +
            '<div class="text-center" style="background:rgba(255,255,255,0.03); padding:8px; border-radius:8px;">' +
            '<div class="text-white" style="font-size:16px; font-weight:700;">' + (SA._lastLatency || 0) + '<span style="font-size:10px; color:#666;">ms</span></div>' +
            ...
            '<button class="cursor-pointer" id="sa-health-clear" style="background:none; border:1px solid #333; color:#888; padding:4px 12px; border-radius:6px; font-size:10px;">Clear Log</button></div>';
