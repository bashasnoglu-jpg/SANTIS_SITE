...
function openPreviewModal(mediaUrl, type) {
    ...
    modal.innerHTML = `
        <div class="relative">
            ${contentHtml}
            <button class="cursor-pointer" data-action="preview-close" style="position:absolute; top:-40px; right:0; background:none; border:none; color:white; font-size:30px;">&times;</button>
        </div>
    `;
