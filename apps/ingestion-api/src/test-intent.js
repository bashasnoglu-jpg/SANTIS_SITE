...
var intent_confirmation_handler_1 = require("./handlers/intent-confirmation.handler");
function runTest() {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    handler = new intent_confirmation_handler_1.IntentConfirmationHandler();
                    mockEvent = {
                    ...
                    return [4 /*yield*/, handler.handle(mockEvent)];
                case 1:
                    _a.sent();
