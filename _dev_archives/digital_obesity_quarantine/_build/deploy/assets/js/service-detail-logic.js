    ...
    function initDetailPage() {
        ...
        var schemaData = {
            ...
            "provider": {
                "@type": "Spa",
                "name": "Santis Club",
                "image": "https://santis.club/assets/img/logo-santis.webp",
                "priceRange": "$$$"
            },
        ...
        if (soulNote) {
            ...
            soulEl.innerHTML = '<strong style="display:block;font-size:0.8rem;color:#666;font-family:\'Inter\',sans-serif;font-style:normal;margin-bottom:5px;text-transform:uppercase;letter-spacing:1px;">Kimler İçin?</strong> ' + soulNote;
        ...
        if (audioGuide) {
            ...
            audioBtn.innerHTML = '<span>Ritüeli Dinle</span> 🎧';
            audioBtn.onclick = function () {
                var audio = new Audio(audioGuide);
                audio.play().catch(function () { alert("Ses dosyası henüz hazır değil. (Demo)"); });
                audioBtn.innerHTML = '<span>Dinleniyor...</span> 🔊';
                audio.onended = function () { audioBtn.innerHTML = '<span>Ritüeli Dinle</span> 🎧'; };
            };
